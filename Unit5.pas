...
begin
  ...
  begin
    ...
    zqry1.SQL.Clear;
    zqry1.SQL.Add('SELECT COUNT(*) FROM pelanggan WHERE nama = :Nama');
    ...
    begin
      ...
      zqry1.SQL.Clear;
      zqry1.SQL.Add('INSERT INTO pelanggan (`nama`, alamat, telp, tipe) ' +
...
begin
  ...
  begin
    ...
    zqry1.SQL.Clear;
    zqry1.SQL.Add('UPDATE pelanggan SET id = (@count:=@count+1);');
    zqry1.ExecSQL;
    ...
    zqry1.Close;
    zqry1.SQL.Clear;
    zqry1.SQL.Add('SELECT MAX(id) AS MaxID FROM pelanggan');
    zqry1.Open;
    ...
    begin
      ...
      zqry1.Close;
      zqry1.SQL.Clear;
      zqry1.SQL.Add('ALTER TABLE pelanggan AUTO_INCREMENT = :NewAutoIncrement');
...
begin
zqry1.SQL.Clear;
zqry1.SQL.Add('UPDATE pelanggan SET `nama` = :Nama, alamat = :Alamat, telp = :Telp, tipe = :Tipe  WHERE id = :ID');
